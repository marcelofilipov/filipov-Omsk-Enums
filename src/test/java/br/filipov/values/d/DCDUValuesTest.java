...
public class DCDUValuesTest {
	...
	public void testGetDescricaoByIdShort() {
		...
		assertNotEquals("N/A", DCDUValues.getDescricaoById((short) 9));
	}
	...
	public void testGetDescricaoByIdInteger() {
		...
		assertNotEquals("N/A", DCDUValues.getDescricaoById(9));
	}
	...
	public void testGetDescricaoByIdLong() {
		...
		assertNotEquals("N/A", DCDUValues.getDescricaoById(9L));
	}	
	...
	public void testGetDescricaoByIdByte() {
		...
		assertNotEquals("N/A", DCDUValues.getDescricaoById((byte) 9));
	}
	...
	public void testParse() {
		...
		assertNotEquals(DCDUValues.DU, DCDUValues.parse(9));
	}	
