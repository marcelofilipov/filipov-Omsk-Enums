...
public class TipoPessoaValuesTest {
	...
	public void testGetDescricaoByIdShort() {
		...
		assertNotEquals("N/A", TipoPessoaValues.getDescricaoById((short) 9));
	}
	...
	public void testGetDescricaoByIdByte() {
		...
		assertNotEquals("N/A", TipoPessoaValues.getDescricaoById((byte) 9));
	}
	...
	public void testGetDescricaoByIdInteger() {
		...
		assertNotEquals("N/A", TipoPessoaValues.getDescricaoById(9));
	}
	...
	public void testGetDescricaoByIdLong() {
		...
		assertNotEquals("N/A", TipoPessoaValues.getDescricaoById(9L));
	}	
	...
	public void testGetSiglaByIdShort() {
		...
		assertNotEquals("NA", TipoPessoaValues.getSiglaById((short) 9));
	}
	...
	public void testGetSiglaByIdByte() {
		...
		assertNotEquals("NA", TipoPessoaValues.getSiglaById((byte) 9));
	}
	...
	public void testGetSiglaByIdInteger() {
		...
		assertNotEquals("NA", TipoPessoaValues.getSiglaById(9));
	}
	...
	public void testGetSiglaByIdLong() {
		...
		assertNotEquals("NA", TipoPessoaValues.getSiglaById(9L));
	}	
	...
	public void testParse() {
		...
		assertNotEquals(TipoPessoaValues.JURIDICA, TipoPessoaValues.parse(9));
	}	
